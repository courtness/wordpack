...
require_once __DIR__ . '/inc/template-helpers.php';
 ...
 function fdl_disable_wp_emojicons() {
   ...
   add_filter( 'tiny_mce_plugins', 'fdl_disable_emojicons_tinymce' );
 }
 add_action( 'init', 'fdl_disable_wp_emojicons' );

 function fdl_disable_emojicons_tinymce( $plugins ) {
   if ( is_array( $plugins ) ) {
